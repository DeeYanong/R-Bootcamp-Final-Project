...
The Dungeons & Dragons dataset, imported from Kaggle, conta
...
```{r}
skimr::skim(monsters)
lapply(monsters[c("armor_class","charisma","constitution","dexterity","hit_points","intelligence","strength","wisdom","challenge_rating")],hist)
...
ggsave(here::here("data","fig_one.png"), figure)
